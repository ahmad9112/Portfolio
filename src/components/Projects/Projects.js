    ...
    <Container fluid className="project-section">
      ...
      <Container>
        <h1 className="project-heading">
          My Video <strong className="purple">Gallery </strong>
        </h1>
        <p style={{ color: "white" }}>
          Here is my some most viewed and Liked videos of All time
        </p>
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://www.youtube.com/embed/yHvXQ_eFo14"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://www.youtube.com/embed/rOFYFqjcycs"
